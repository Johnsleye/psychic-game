...
var computerChoices = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z']; //array of letters to choose from

document.onkeyup = function(event) {
    var userGuess = String.fromCharCode(event.keyCode).toLowerCase(); //taking in user guess
    var computerGuess = computerChoices[Math.floor(Math.random()*computerChoices.length)]; //computer selects random letter from the array
    ...
    if (userGuess == computerGuess) {
        ...
        losses++;
        alert("Ooops! You did not quess right. Start again.");
        guessesLeft = 9;
   ...
   var html = "<h1>The Psychic Game</h1><p>Guess what letter I'm thinking of!</p><p>Total Wins: " + 
   wins + 
   "</p><p>Total Losses: " + 
   losses + 
   "</p><p>Guesses Left: " + 
